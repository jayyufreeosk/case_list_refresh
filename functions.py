...
def wm_formatter(wm_df_raw):
    ...
    # wm_df_formatted['Start date']= pd.to_datetime(wm_df_formatted['Start date'])
    # wm_df_formatted['End date']= pd.to_datetime(wm_df_formatted['End date'])
...
# def sc_formatter_old(raw_sc_df):
#     # Formatting
...
# def wm_sql_metrics_old(not_tuple):
...
# def wm_formatter_old(raw_wm_df):
#     # Formatting
#     print(f'Successfully returned the MySQL query')
